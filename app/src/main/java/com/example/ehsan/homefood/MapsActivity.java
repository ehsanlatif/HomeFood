...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
        ...
        locationManager.requestLocationUpdates(provider, 20000, 0, new android.location.LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                myLocMarker.remove();
                myLocMarker=drawMarker(location);
            }
...
//                googleMap.animateCamera(CameraUpdateFactory.newCameraPosition(cameraPosition));
        Marker marker = mMap.addMarker(new MarkerOptions().position(new LatLng(latitude, longitude)).icon(BitmapDescriptorFactory.fromResource(R.drawable.food_loc_icon)));
        marker.setTag("Food");
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                Toast.makeText(getApplicationContext(),"Your Food is here!",Toast.LENGTH_SHORT).show();return true;
            }
        });
    }
